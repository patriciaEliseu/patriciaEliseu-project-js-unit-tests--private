...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
    ...
    it('Teste se circle retorna undefined, caso o parâmetro passado não seja um número.', () => {
        expect(circle('patricia')).toBeUndefined();
    });
    ...
    // Teste se deneste stro do objeto retornado, a função retorna uma key com value igual a área correta para um círculo de raio 3.
    ...
    it('Teste que a função retorna, num objeto, os dados corretos de um círculo de raio 3.', () => {
        // não inclui a area pq já tinha feito na linha 53.
